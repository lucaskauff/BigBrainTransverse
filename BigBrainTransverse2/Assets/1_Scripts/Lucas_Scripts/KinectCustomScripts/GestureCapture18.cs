...
public class GestureCapture18 : MonoBehaviour
{
            ...
            */
            ...
            if (manager.IsUserDetected())
            {
                    ...
                    /*&& manager.IsJointTracked(userId2, iJointIndex) && manager.IsJointTracked(userId2, iJointIndex1)*/)
                {
                    ...
                    /*
                    Vector3 posJoint2 = manager.GetRawSkeletonJointPos(userId2, iJointIndex);
                    Vector3 posJoint3 = manager.GetRawSkeletonJointPos(userId2, iJointIndex1);
                    */
